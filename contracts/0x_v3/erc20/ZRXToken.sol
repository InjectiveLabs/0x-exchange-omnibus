...
abstract contract Token {
    ...
    function totalSupply() virtual view public returns (uint supply) {}
    ...
    function allowance(address _owner, address _spender) virtual view public returns (uint remaining) {}
...
contract ERC20Token is Token {
    ...
    function balanceOf(address _owner) override virtual public view returns (uint) {
        return balances[_owner];
    }

    function approve(address _spender, uint _value) override virtual public returns (bool) {
        allowed[msg.sender][_spender] = _value;
        emit Approval(msg.sender, _spender, _value);
        return true;
    }

    function allowance(address _owner, address _spender) override virtual view public returns (uint) {
