...
abstract contract OrderValidationUtils is
    Addresses,
    AssetBalance
{
    ...
    /// @return orderInfo The orderInfo (hash, status, and `takerAssetAmount` already filled for the given order).
    /// @return fillableTakerAssetAmount amount of the order's `takerAssetAmount` that is fillable given all on-chain state.
    /// @return isValidSignature Validity of the provided signature.
    ...
    /// @return ordersInfo The ordersInfo (array of the hash, status, and `takerAssetAmount` already filled for each order).
    ...
    /// @return transferableAssetAmount The amount of the asset tranferable by the owner.
    ...
    /// @return transferableAssetAmount transferableAssetAmount Amount of maker asset that can be transferred.
    ...
    /// @return valid The validatity of the asset data.
    ...
    /// @return isValid Whether or not the order should be considered valid.
    ...
    /// @return flag A boolean reflecting whether or not the starting asset data was duplicated.
