...
import "../asset-proxy/interfaces/IAssetData.sol";
import "../asset-proxy/interfaces/IAssetProxy.sol";
import "../erc20/LibERC20Token.sol";
import "../erc721/interfaces/IERC721Token.sol";
import "../erc1155/interfaces/IERC1155.sol";
import "../asset-proxy/interfaces/IChai.sol";
...
abstract contract AssetBalance is
    Addresses
{
    // 2^256 - 1
    ...
    /// @return balance Number of assets (or asset baskets) held by owner.
    ...
    /// @return balances Array of asset balances from getBalance(), with each element
    ...
    /// @param ownerAddress Owner of the assets specified by assetData.
    /// @param assetData Details of asset, encoded per the AssetProxy contract specification.
    /// @return allowance Number of assets (or asset baskets) that the corresponding AssetProxy is authorized to spend.
    ...
    /// @param ownerAddress Owner of the assets specified by assetData.
    /// @param assetData Array of asset details, each encoded per the AssetProxy contract specification.
    /// @return allowances An array of asset allowances from getAllowance(), with each
    ...
    /// @param ownerAddress Owner of the assets specified by assetData.
    /// @param assetData Array of asset details, each encoded per the AssetProxy contract specification.
    /// @return balances An array of asset balances from getBalance().
    /// @return allowances An array of asset allowances from getAllowance(), with each element
    /// corresponding to the same-indexed element in the assetData input.
    ...
    /// @param daiAmount Resulting Dai amount.
