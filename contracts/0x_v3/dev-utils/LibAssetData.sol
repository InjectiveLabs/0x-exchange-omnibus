...
library LibAssetData {
    ...
    /// @return assetProxyId The AssetProxy identifier.
    /// @return tokenAddress The address of the ERC-20 contract hosting this asset.
    ...
    /// In return values each element of the arrays corresponds to the
    ...
    /// @return tokenIds An array of the identifiers of theassets to be traded.
    /// @return tokenValues An array of asset amounts to be traded, and callback data.
    /// @return callbackData
    ...
    /// @return nestedAssetData An array of the AssetProxy-compliant data describing each asset to be traded.
