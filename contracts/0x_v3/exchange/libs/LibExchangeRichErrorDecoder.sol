...
library LibExchangeRichErrorDecoder {
    ...
    /// @param encoded ABI-encoded revert error.
    /// @return verifyingContractAddress The verifying contract address.
    /// @return data
    ...
    /// @param encoded ABI-encoded revert error.
    /// @return errorCode The error code.
    /// @return expectedAssetFillAmount The expected asset fill amount.
    /// @return actualAssetFillAmount The actual asset fill amount.
